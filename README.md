...
- [ ] Explain what a token is used for.
  ...
  Verification that a client has been authenticated with the server, usually done by logging in with a username and password.

- [ ] What steps can you take in your web apps to keep your data secure?

  Require client authentication, and require that authentication when posting or receiving data from api calls.

- [ ] Describe how web servers work.

  Web servers communicate with clients or other servers by using HTTP requests and responses, or other protocols if required. For your average page, this will usually be the client requesting a page, or actions to take via API, like adding data to a server, and responses from the server either providing data or responses saying why requests were denied.
